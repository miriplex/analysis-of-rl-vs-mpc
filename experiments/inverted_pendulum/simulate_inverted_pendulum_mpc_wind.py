...
def run() -> None:
    ...
    fig.suptitle("Linearized Inverted Pendulum with MPC Under Wind Disturbance", fontsize=18, y=0.985)
    ...
    out_path = out_dir / "closed_loop_linearized_inverted_pendulum_mpc_wind.png"
